function loadDoc12() {
  ...
  $("#carousel").html(data);
    ...
    paragraph +="<p>The first thing that stood out to me at Lava Beds was the butte near the southern entrance, Schonchin Butte.  Not the park's main feature, but still impressive nonetheless, it made the views better.  I found a viewpoint up the road and loved what I saw.  As I drove around Schonchin Butte, I began noticing the lava beds and reached Devil's Homestead, a large collection of lava flows that reminded me of Lava Butte near Bend, Oregon.  I always like places with the name Devil in it, and Devil's Homestead was no exception, a flat bed of black molten lava.  It diversified the area and brought back memories of Lava Butte, though obviously, slightly different.</p>";
    ...
    paragraph +="</video><script src='videos/html5ext.js' type='text/javascript'></script><img src='../img/lava-beds-map.jpg' class='img-responsive'/></div></div></div>";
