function loadDoc8() {
  ...
  $("#carousel").html(data);
    ...
    paragraph +="<p>I made it to the main viewpoint of Emerald Bay and was shocked by its amazing beauty, easily the best viewpoint I saw, the water was perfectly blue, the trees were perfectly green, and Fanette Island in the middle, with the contrast between the Bay and the rest of the Lake almost fjord-like. It was the perfect viewpoint to see and clearly the best stop I made at Lake Tahoe.</p>";
