function loadDoc1() {
  ...
  xmlhttp.open("GET", "json/shasta.json", true);
  xmlhttp.send();
  ...
  console.log( "Load was performed." );
    ...
    paragraph +="<p>The first thing anyone should know about Northern California is the prominence of Mt. Shasta in the area.  It's hard to miss the tall and up-close Mt. Shasta, which along with its sister peak, Shastina, makes it a sight for sore eyes.  As the second highest peak in the Cascades and fifth highest in California, it's no wonder why it's hard not to look at Mt. Shasta while driving by.  Starting to show just at the Oregon border, after a brief stop at a nice rest stop with a view of the Klamath River, I saw a sign to a vista point and knew I needed to stop.  So I stopped at the Shasta Valley Vista Point and got my first major view of Mt. Shasta.  It was amazing to see, with little standing in its way.  After that, I made my first planned stop in the oddly named town of Yreka.</p>";
    paragraph +="<p>Coincidentally, I needed to fill up with gas, so the stop couldn't have been any more perfect, but I briefly walked around the historic mining part of town, along with the city entrance, so I continued my way from Yreka, which forms a palindrome when paired to Bakery.  Yreka Bakery.  Who knew?  Another rest stop followed Yreka, which also served as a vista point as well, for now we were really close to Mt. Shasta.  It was pretty obvious I needed to stop for more pictures, and I did.  A few miles down the road was my next stop, the funniest named city in California (maybe the world): Weed, California.</p>";
    ...
    paragraph +="<div class='col-md-6 story'>";
    paragraph +="<h1>Facts about Mt. Shasta and More...</h1>";
    ...
    paragraph +="<p>Weed, California is not named after Marijuana but after the town's founder, Abner Weed, who founded a local lumber mill.</p></div></div></div>";
